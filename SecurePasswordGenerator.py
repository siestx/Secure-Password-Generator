...
import os
def enterprogram():
    ctypes.windll.kernel32.SetConsoleTitleA("SecurePasswordGenerator - V1.9 - Owned By Zenperr - Updated By Rask")
    print("""
                                            ░██████╗██████╗░░██████╗░███╗░░██╗
                                            ██╔════╝██╔══██╗██╔════╝░████╗░██║
                                            ╚█████╗░██████╔╝██║░░██╗░██╔██╗██║
    ...
    if lg == 1:
        ...
        print("""
                                ...
                                Tool Owned By Zenperr | Help: Raphiel/Raluvy95/Gam3rr | Edited: Rask
                                                                                                                                            """)
        print(Fore.LIGHTMAGENTA_EX + "["  + Fore.LIGHTWHITE_EX + "CONSOLE" + Fore.LIGHTMAGENTA_EX + "]" + Fore.LIGHTWHITE_EX + "Welcome back " + usr + ",select an option to continue ( Currently on version 1.9 )")
        ...
        if ch1 == 4:
            ...
            print(Fore.LIGHTMAGENTA_EX + "[" + Fore.LIGHTWHITE_EX + "Version" + Fore.LIGHTMAGENTA_EX + "]" + Fore.LIGHTWHITE_EX + " " + "1.9")
